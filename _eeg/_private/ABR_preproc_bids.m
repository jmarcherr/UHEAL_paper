...
try
    ...
    filename_bids = '/work1/jonmarc/UHEAL_master/UHEAL_paper/_eeg/_ABR/_outputs/_bids'
    cfg_bids = [];
    cfg_bids.method = 'copy';
    cfg_bids.suffix = 'eeg';
    cfg_bids.dataset      = filename_bdf;%string, filename of the input data
    cfg_bids.outputfile   = [filename_bids filesep subid];%string, optional filename for the output data (default is automatic)
    bids = data2bids(cfg_bids)
