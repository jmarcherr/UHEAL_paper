...
function data = FFR_preproc_NF(dataset_root,subid)
%% Preprocessing of FFR data for noise floor
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%
%   Inputs:
...
try
    ...
    triggers = [10,20,22]; % 100 or 102 depending on lab
    ...
    warning(ME.message)
    data.error = ['error in FFR_preproc_NF: ' ME.message];
    data.subid = subid;
    data.subinfo = dataalm.subinfo;
end
end
