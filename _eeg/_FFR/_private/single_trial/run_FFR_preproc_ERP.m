...
addpath(datadir)
% save dir
savedir = '/work3/jonmarc/UHEAL_paper/_eeg/_FFR/_outputs/_derivatives/_ERP';
...
parfor ss=1:numsub
    % run preprocessing
    data_preproc = FFR_preproc_ERP(datadir,subids{ss});
    % run analysis
    data_ffr = FFR_ERP_analysis(data_preproc);
    % save data
