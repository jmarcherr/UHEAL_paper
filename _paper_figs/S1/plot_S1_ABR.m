...
abr_sub_trace.CP_SG = uheal_data.CP_SG;
...
YNH_idx = find(abr_sub_trace.age<=25 & abr_sub_trace.CP_SG & ~abr_sub_trace.rjt_sub); 
MANH_idx = find(abr_sub_trace.age>25 & abr_sub_trace.age<50 & abr_sub_trace.CP_SG & ~abr_sub_trace.rjt_sub);
ONH_idx = find(abr_sub_trace.age>=50 & abr_sub_trace.CP_SG & ~abr_sub_trace.rjt_sub);
HI_idx = find(~abr_sub_trace.CP_SG & ~abr_sub_trace.rjt_sub & abr_sub_trace.age>30);
%subplot(1,3,[1 2])
...
abr_data_nh = IndexedStructCopy(abr_data,find(abr_sub_trace.CP_SG & ~abr_sub_trace.rjt_sub));
...
%% Stats
% AP
uheal_data.CP_new = ~uheal_data.CP_SG;
var = 'AP_amp_pm';
labels = '\muV'
lims = [-0.2 1.1];
figure
