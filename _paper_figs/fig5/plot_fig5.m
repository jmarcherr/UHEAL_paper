...
%%
% thisdir = cd;
% cd('/work3/jonmarc/UHEAL_master/UHEAL/UHEAL_data/scraped/uheal_data_table/uheal_data_current_EEG')
...
% fig = gcf;
% box off
% %saveas(fig,'figs/TS_drift_upright_pt7filt2','svg')
...
% fig = gcf;
% %saveas(fig,'figs/itpc_single_freq','svg')
% 
% %% individuals
% close all
% figure('renderer','painters')
...
% fig = gcf;
% %saveas(fig,'figs/itpc_single_freq_ind','svg')
% 
% 
% 
% 
...
% 
% end
%     %saveas(fig,'figs/binned_phase','svg')
%     %saveas(fig,'figs/binned_phase_ind','svg')
% 
...
% hleg.Location = 'Best'
% fig = gcf;
% saveas(fig,['figs/fit_' num2str(f_idx(ff)) 'hz'],'svg')
% 
% figure(ff+3)
% set(gcf,'renderer','painters')
% subplot(1,2,1)
...
% fig = gcf;
% saveas(fig,['figs/fit_stats_' num2str(f_idx(ff)) 'hz'],'svg')
% 
% 
% figure(ff+10)
% set(gcf,'renderer','painters')
...
% 
% fig = gcf;
% saveas(fig,['figs/adjR2_fit_' num2str(ff) 'Hz'],'svg')
% end
% 
