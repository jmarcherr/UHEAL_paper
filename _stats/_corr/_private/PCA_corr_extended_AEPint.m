...
Varnames = {'AP','FFR_{SNR}','ITPC_{F0-F1:9}','Negativity','P2 adaptation','P2-N1_{ISI}'}
...
fig=gcf;
%cd(root)
saveas(fig,['figs/pca_eeg_clean_extended_AEPint'],'svg')
...
saveas(fig,['figs/corr_eeg_extended_AEPint'],'svg')
