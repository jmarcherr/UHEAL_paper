...
out<-kable(age_tab)
write.csv2(age_tab, "extended_age_tab_EVERYTHING_PTA.csv")
...
out<-kable(sex_tab)
write.csv2(sex_tab, "extended_sex_tab_EVERYTHING_PTA.csv")
# PTA table
p_corr_pta = print(p.adjust(p_val_pta,method='bonferroni'))
...
pta_tab
out<-kable(pta_tab)
write.csv2(pta_tab, "extended_pta_tab_EVERYTHING_PTA.csv")
