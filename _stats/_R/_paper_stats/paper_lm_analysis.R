...
### 7. linear models for Y~Age+Sex+PTAehf ######################
...
for (c in c('PTA_lf',
            ...
            'acalos_AC_slope_1','acalos_AC_slope_2','acalos_AC_slope_3','acalos_AC_slope_4',
            'nesi','tts','ssq12_mean')){
  temp=print(summary(lm(paste(c,"~ Age+sex+PTA_hf"), data=uheal_data)))
  # age values
  est_age = rbind(est_age,summary(lm(paste(c,"~ Age+sex+PTA_hf"), data=uheal_data))$coefficients[2,1])
  err_age = rbind(err_age,summary(lm(paste(c,"~ Age+sex+PTA_hf"), data=uheal_data))$coefficients[2,2])
  t_age = rbind(t_age,summary(lm(paste(c,"~ Age+sex+PTA_hf"), data=uheal_data))$coefficients[2,3])
  p_val_age = rbind(p_val_age,summary(lm(paste(c,"~ Age+sex+PTA_hf"), data=uheal_data))$coefficients[2,4])
  # sex values
  est_sex = rbind(est_sex,summary(lm(paste(c,"~ Age+sex+PTA_hf"), data=uheal_data))$coefficients[3,1])
  err_sex = rbind(err_sex,summary(lm(paste(c,"~ Age+sex+PTA_hf"), data=uheal_data))$coefficients[3,2])
  t_sex = rbind(t_sex,summary(lm(paste(c,"~ Age+sex+PTA_hf"), data=uheal_data))$coefficients[3,3])
  p_val_sex = rbind(p_val_sex,summary(lm(paste(c,"~ Age+sex+PTA_hf"),data=uheal_data))$coefficients[3,4])
  # PTA values
  est_pta = rbind(est_pta,summary(lm(paste(c,"~ Age+sex+PTA_hf"), data=uheal_data))$coefficients[4,1])
  err_pta = rbind(err_pta,summary(lm(paste(c,"~ Age+sex+PTA_hf"), data=uheal_data))$coefficients[4,2])
  t_pta = rbind(t_pta,summary(lm(paste(c,"~ Age+sex+PTA_hf"), data=uheal_data))$coefficients[4,3])
  p_val_pta = rbind(p_val_pta,summary(lm(paste(c,"~ Age+sex+PTA_hf"),data=uheal_data))$coefficients[4,4])
...
out<-kable(age_tab)
write.csv2(age_tab, "7_age_tab_PTAhf_corrected.csv")
...
out<-kable(sex_tab)
write.csv2(sex_tab, "7_sex_tab_PTAhf_corrected.csv")
...
pta_tab
out<-kable(pta_tab)
write.csv2(pta_tab, "7_PTAhf_tab_PTAhf_corrected.csv")
